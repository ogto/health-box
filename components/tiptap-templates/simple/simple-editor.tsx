...
const ImageDropUpload = Extension.create<{
  upload: typeof handleImageUpload
  ...
  addProseMirrorPlugins() {
    return [
      new Plugin({
        key: new PluginKey("imageDropUpload"),
        props: {
...
export function SimpleEditor({
  ...
  const showUploadError = (error: Error) => {
